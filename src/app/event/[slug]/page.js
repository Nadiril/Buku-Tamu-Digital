      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-muted text-sm max-w-xs mx-auto">
            Link yang Anda akses tidak valid atau acara sudah tidak tersedia.
          </p>
        </div>
      </div>
    );
        ...
        <div className="relative text-center max-w-md mx-4">
          ...
          <div className="glass-card rounded-2xl p-5 text-left space-y-3 mb-6">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-foreground font-medium">{form.nama}</span>
            </div>
            <div className="flex justify-between text-sm">
          ...
          <Button
            ...
            onClick={() => {
              setSubmitted(false);
              setForm({ nama: "", instansi: "", tujuan: "", no_hp: "" });
            }}
          >
            Daftar Tamu Lain
          </Button>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden py-10">
      ...
      <div className="relative w-full max-w-lg mx-4">
        ...
        <p className="text-center text-xs text-muted/50 mt-6">
          Buku Tamu Digital — Powered by Next.js
        </p>
      </div>
    </div>
  );
